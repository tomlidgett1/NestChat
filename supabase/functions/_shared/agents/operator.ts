...
export const operatorAgent: AgentConfig = {
  ...
  maxTokens: 2048,
  toolPolicy: {
    allowedNamespaces: ['memory.read', 'memory.write', 'email.read', 'email.write', 'calendar.read', 'calendar.write', 'contacts.read', 'web.search', 'knowledge.search', 'messaging.react', 'messaging.effect', 'media.generate'],
